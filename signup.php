            ...
            <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
              ...
              <form method="post" action="/">
                <div class="row g-3">
                  <!-- col -->
                  <div class="col">
                    <!-- input --><input  name="firstName" type="text" class="form-control" placeholder="First name" aria-label="First name" required="">
                  </div>
                  <div class="col">
                    <!-- input --><input  name="lastName" type="text" class="form-control" placeholder="Last name" aria-label="Last name" required="">
                  </div>
                  <div class="col-12">
    
                    <!-- input --><input name="email" type="email" class="form-control" id="inputEmail4" placeholder="Email" required="" oldautocomplete="remove" autocomplete="off">
                  ...
                  <div class="col-12">
                    ...
                    <!-- input --><input name="pwd" type="password" class="form-control" id="inputPassword4" placeholder="Password" required="" oldautocomplete="remove" autocomplete="off">
                  ...
                  <!-- btn -->
                  <div class="col-12 d-grid"><input type="submit"name="submit"  value="Register" class="btn btn-primary"> 
                  </div>
